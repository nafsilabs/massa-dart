...
class MassaPlatform extends FlutterRustBridgeBase<MassaWire> {
  MassaPlatform(ffi.DynamicLibrary dylib) : super(MassaWire(dylib));
...
class MassaWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  MassaWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  MassaWire.fromLookup(
  ...
  late final _wire_sumPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_sum');
  late final _wire_sum =
      _wire_sumPtr.asFunction<void Function(int, int, int)>();
  ...
  late final _wire_subPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_sub');
