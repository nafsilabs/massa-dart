// ignore_for_file: inference_failure_on_function_return_type, constant_identifier_names, non_constant_identifier_names
...
// Slightly modified from: https://github.com/mnito/thirds

const _OUT_LENGTH = 32;
const _BLOCK_LENGTH = 64;
const _BLOCK_WORD_LENGTH = _BLOCK_LENGTH ~/ 4;

const _CHUNK_LENGTH = 1024;

const _FLAG_CHUNK_START = 1 << 0;
const _FLAG_CHUNK_END = 1 << 1;
const _FLAG_PARENT = 1 << 2;
const _FLAG_ROOT = 1 << 3;

const _MAX_WORD_SIZE = 0xffffffff;
...
class _HashContext {
  ...
  _HashContext._(dynamic key, int flags)
