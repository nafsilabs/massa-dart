...
final $typed_data.Uint8List addStakingSecretKeysRequestDescriptor =
    $convert.base64Decode(
        'ChtBZGRTdGFraW5nU2VjcmV0S2V5c1JlcXVlc3QSHwoLc2VjcmV0X2tleXMYASADKAlSCnNlY3JldEtleXM=');
...
final $typed_data.Uint8List getMipStatusResponseDescriptor = $convert.base64Decode(
    'ChRHZXRNaXBTdGF0dXNSZXNwb25zZRJLChFtaXBzdGF0dXNfZW50cmllcxgBIAMoCzIeLm1hc3NhLm1vZGVsLnYxLk1pcFN0YXR1c0VudHJ5UhBtaXBzdGF0dXNFbnRyaWVz');
...
final $typed_data.Uint8List getNodeStatusResponseDescriptor = $convert.base64Decode(
    'ChVHZXROb2RlU3RhdHVzUmVzcG9uc2USMgoGc3RhdHVzGAEgASgLMhoubWFzc2EubW9kZWwudjEuTm9kZVN0YXR1c1IGc3RhdHVz');
...
final $typed_data.Uint8List removeStakingAddressesRequestDescriptor =
    $convert.base64Decode(
        'Ch1SZW1vdmVTdGFraW5nQWRkcmVzc2VzUmVxdWVzdBIcCglhZGRyZXNzZXMYASADKAlSCWFkZHJlc3Nlcw==');
...
final $typed_data.Uint8List signMessagesResponseDescriptor = $convert.base64Decode(
    'ChRTaWduTWVzc2FnZXNSZXNwb25zZRIdCgpwdWJsaWNfa2V5GAEgASgJUglwdWJsaWNLZXkSHgoKc2lnbmF0dXJlcxgDIAMoCVIKc2lnbmF0dXJlcw==');
