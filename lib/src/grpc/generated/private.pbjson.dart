...
const AddToBootstrapBlacklistRequest$json = {
...
const AddStakingSecretKeysRequest$json = {
  ...
  '2': [
    {'1': 'secret_keys', '3': 1, '4': 3, '5': 9, '10': 'secretKeys'},
  ],
};
...
final $typed_data.Uint8List getMipStatusResponseDescriptor = $convert.base64Decode(
    'ChRHZXRNaXBTdGF0dXNSZXNwb25zZRJLChFtaXBzdGF0dXNfZW50cmllcxgBIAMoCzIeLm1hc3'
    'NhLm1vZGVsLnYxLk1pcFN0YXR1c0VudHJ5UhBtaXBzdGF0dXNFbnRyaWVz');
...
final $typed_data.Uint8List getNodeStatusResponseDescriptor = $convert.base64Decode(
    'ChVHZXROb2RlU3RhdHVzUmVzcG9uc2USMgoGc3RhdHVzGAEgASgLMhoubWFzc2EubW9kZWwudj'
    'EuTm9kZVN0YXR1c1IGc3RhdHVz');

@$core.Deprecated('Use getPeersWhitelistRequestDescriptor instead')
const GetPeersWhitelistRequest$json = {
...
const SignMessagesResponse$json = {
  ...
  '2': [
    ...
    {'1': 'signatures', '3': 3, '4': 3, '5': 9, '10': 'signatures'},
  ],
};
...
final $typed_data.Uint8List signMessagesResponseDescriptor = $convert.base64Decode(
    'ChRTaWduTWVzc2FnZXNSZXNwb25zZRIdCgpwdWJsaWNfa2V5GAEgASgJUglwdWJsaWNLZXkSHg'
    'oKc2lnbmF0dXJlcxgDIAMoCVIKc2lnbmF0dXJlcw==');

@$core.Deprecated('Use shutdownGracefullyRequestDescriptor instead')
const ShutdownGracefullyRequest$json = {
