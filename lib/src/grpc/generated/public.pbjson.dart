...
@$core.Deprecated('Use finalityLevelDescriptor instead')
const FinalityLevel$json = {
  '1': 'FinalityLevel',
  '2': [
    {'1': 'FINALITY_LEVEL_UNSPECIFIED', '2': 0},
    {'1': 'FINALITY_LEVEL_CANDIDATE', '2': 1},
    {'1': 'FINALITY_LEVEL_FINAL', '2': 2},
  ],
};

/// Descriptor for `FinalityLevel`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List finalityLevelDescriptor = $convert.base64Decode(
    'Cg1GaW5hbGl0eUxldmVsEh4KGkZJTkFMSVRZX0xFVkVMX1VOU1BFQ0lGSUVEEAASHAoYRklOQU'
    'xJVFlfTEVWRUxfQ0FORElEQVRFEAESGAoURklOQUxJVFlfTEVWRUxfRklOQUwQAg==');
...
@$core.Deprecated('Use newSlotABICallStacksRequestDescriptor instead')
const NewSlotABICallStacksRequest$json = {
  '1': 'NewSlotABICallStacksRequest',
  '2': [
    {'1': 'finality_level', '3': 1, '4': 1, '5': 14, '6': '.massa.api.v1.FinalityLevel', '10': 'finalityLevel'},
  ],
};

/// Descriptor for `NewSlotABICallStacksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newSlotABICallStacksRequestDescriptor = $convert.base64Decode(
    'ChtOZXdTbG90QUJJQ2FsbFN0YWNrc1JlcXVlc3QSQgoOZmluYWxpdHlfbGV2ZWwYASABKA4yGy'
    '5tYXNzYS5hcGkudjEuRmluYWxpdHlMZXZlbFINZmluYWxpdHlMZXZlbA==');

@$core.Deprecated('Use newSlotABICallStacksResponseDescriptor instead')
const NewSlotABICallStacksResponse$json = {
  '1': 'NewSlotABICallStacksResponse',
  '2': [
    {'1': 'slot', '3': 1, '4': 1, '5': 11, '6': '.massa.model.v1.Slot', '10': 'slot'},
    {'1': 'asc_call_stacks', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.ASCABICallStack', '10': 'ascCallStacks'},
    {'1': 'operation_call_stacks', '3': 3, '4': 3, '5': 11, '6': '.massa.api.v1.OperationABICallStack', '10': 'operationCallStacks'},
  ],
};

/// Descriptor for `NewSlotABICallStacksResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newSlotABICallStacksResponseDescriptor = $convert.base64Decode(
    'ChxOZXdTbG90QUJJQ2FsbFN0YWNrc1Jlc3BvbnNlEigKBHNsb3QYASABKAsyFC5tYXNzYS5tb2'
    'RlbC52MS5TbG90UgRzbG90EkUKD2FzY19jYWxsX3N0YWNrcxgCIAMoCzIdLm1hc3NhLmFwaS52'
    'MS5BU0NBQklDYWxsU3RhY2tSDWFzY0NhbGxTdGFja3MSVwoVb3BlcmF0aW9uX2NhbGxfc3RhY2'
    'tzGAMgAygLMiMubWFzc2EuYXBpLnYxLk9wZXJhdGlvbkFCSUNhbGxTdGFja1ITb3BlcmF0aW9u'
    'Q2FsbFN0YWNrcw==');

@$core.Deprecated('Use newSlotTransfersRequestDescriptor instead')
const NewSlotTransfersRequest$json = {
  '1': 'NewSlotTransfersRequest',
  '2': [
    {'1': 'finality_level', '3': 1, '4': 1, '5': 14, '6': '.massa.api.v1.FinalityLevel', '10': 'finalityLevel'},
  ],
};

/// Descriptor for `NewSlotTransfersRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newSlotTransfersRequestDescriptor = $convert.base64Decode(
    'ChdOZXdTbG90VHJhbnNmZXJzUmVxdWVzdBJCCg5maW5hbGl0eV9sZXZlbBgBIAEoDjIbLm1hc3'
    'NhLmFwaS52MS5GaW5hbGl0eUxldmVsUg1maW5hbGl0eUxldmVs');

@$core.Deprecated('Use newSlotTransfersResponseDescriptor instead')
const NewSlotTransfersResponse$json = {
  '1': 'NewSlotTransfersResponse',
  '2': [
    {'1': 'slot', '3': 1, '4': 1, '5': 11, '6': '.massa.model.v1.Slot', '10': 'slot'},
    {'1': 'transfers', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.TransferInfo', '10': 'transfers'},
  ],
};

/// Descriptor for `NewSlotTransfersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newSlotTransfersResponseDescriptor = $convert.base64Decode(
    'ChhOZXdTbG90VHJhbnNmZXJzUmVzcG9uc2USKAoEc2xvdBgBIAEoCzIULm1hc3NhLm1vZGVsLn'
    'YxLlNsb3RSBHNsb3QSOAoJdHJhbnNmZXJzGAIgAygLMhoubWFzc2EuYXBpLnYxLlRyYW5zZmVy'
    'SW5mb1IJdHJhbnNmZXJz');
...
@$core.Deprecated('Use getOperationABICallStacksRequestDescriptor instead')
const GetOperationABICallStacksRequest$json = {
  '1': 'GetOperationABICallStacksRequest',
  '2': [
    {'1': 'operation_ids', '3': 1, '4': 3, '5': 9, '10': 'operationIds'},
  ],
};

/// Descriptor for `GetOperationABICallStacksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getOperationABICallStacksRequestDescriptor = $convert.base64Decode(
    'CiBHZXRPcGVyYXRpb25BQklDYWxsU3RhY2tzUmVxdWVzdBIjCg1vcGVyYXRpb25faWRzGAEgAy'
    'gJUgxvcGVyYXRpb25JZHM=');

@$core.Deprecated('Use aBICallStackElementDescriptor instead')
const ABICallStackElement$json = {
  '1': 'ABICallStackElement',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {'1': 'parameters', '3': 2, '4': 3, '5': 9, '10': 'parameters'},
    {'1': 'return_value', '3': 3, '4': 1, '5': 9, '10': 'returnValue'},
  ],
};

/// Descriptor for `ABICallStackElement`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aBICallStackElementDescriptor = $convert.base64Decode(
    'ChNBQklDYWxsU3RhY2tFbGVtZW50EhIKBG5hbWUYASABKAlSBG5hbWUSHgoKcGFyYW1ldGVycx'
    'gCIAMoCVIKcGFyYW1ldGVycxIhCgxyZXR1cm5fdmFsdWUYAyABKAlSC3JldHVyblZhbHVl');

@$core.Deprecated('Use aBICallStackElementCallDescriptor instead')
const ABICallStackElementCall$json = {
  '1': 'ABICallStackElementCall',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {'1': 'parameters', '3': 2, '4': 3, '5': 9, '10': 'parameters'},
    {'1': 'sub_calls', '3': 3, '4': 3, '5': 11, '6': '.massa.api.v1.ABICallStackElementParent', '10': 'subCalls'},
    {'1': 'return_value', '3': 4, '4': 1, '5': 9, '10': 'returnValue'},
  ],
};

/// Descriptor for `ABICallStackElementCall`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aBICallStackElementCallDescriptor = $convert.base64Decode(
    'ChdBQklDYWxsU3RhY2tFbGVtZW50Q2FsbBISCgRuYW1lGAEgASgJUgRuYW1lEh4KCnBhcmFtZX'
    'RlcnMYAiADKAlSCnBhcmFtZXRlcnMSRAoJc3ViX2NhbGxzGAMgAygLMicubWFzc2EuYXBpLnYx'
    'LkFCSUNhbGxTdGFja0VsZW1lbnRQYXJlbnRSCHN1YkNhbGxzEiEKDHJldHVybl92YWx1ZRgEIA'
    'EoCVILcmV0dXJuVmFsdWU=');

@$core.Deprecated('Use aBICallStackElementParentDescriptor instead')
const ABICallStackElementParent$json = {
  '1': 'ABICallStackElementParent',
  '2': [
    {'1': 'element', '3': 1, '4': 1, '5': 11, '6': '.massa.api.v1.ABICallStackElement', '9': 0, '10': 'element'},
    {'1': 'element_call', '3': 2, '4': 1, '5': 11, '6': '.massa.api.v1.ABICallStackElementCall', '9': 0, '10': 'elementCall'},
  ],
  '8': [
    {'1': 'call_stack_element'},
  ],
};

/// Descriptor for `ABICallStackElementParent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aBICallStackElementParentDescriptor = $convert.base64Decode(
    'ChlBQklDYWxsU3RhY2tFbGVtZW50UGFyZW50Ej0KB2VsZW1lbnQYASABKAsyIS5tYXNzYS5hcG'
    'kudjEuQUJJQ2FsbFN0YWNrRWxlbWVudEgAUgdlbGVtZW50EkoKDGVsZW1lbnRfY2FsbBgCIAEo'
    'CzIlLm1hc3NhLmFwaS52MS5BQklDYWxsU3RhY2tFbGVtZW50Q2FsbEgAUgtlbGVtZW50Q2FsbE'
    'IUChJjYWxsX3N0YWNrX2VsZW1lbnQ=');

@$core.Deprecated('Use aBICallStackDescriptor instead')
const ABICallStack$json = {
  '1': 'ABICallStack',
  '2': [
    {'1': 'call_stack', '3': 1, '4': 3, '5': 11, '6': '.massa.api.v1.ABICallStackElementParent', '10': 'callStack'},
  ],
};

/// Descriptor for `ABICallStack`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aBICallStackDescriptor = $convert.base64Decode(
    'CgxBQklDYWxsU3RhY2sSRgoKY2FsbF9zdGFjaxgBIAMoCzInLm1hc3NhLmFwaS52MS5BQklDYW'
    'xsU3RhY2tFbGVtZW50UGFyZW50UgljYWxsU3RhY2s=');

@$core.Deprecated('Use getOperationABICallStacksResponseDescriptor instead')
const GetOperationABICallStacksResponse$json = {
  '1': 'GetOperationABICallStacksResponse',
  '2': [
    {'1': 'call_stacks', '3': 1, '4': 3, '5': 11, '6': '.massa.api.v1.ABICallStack', '10': 'callStacks'},
  ],
};

/// Descriptor for `GetOperationABICallStacksResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getOperationABICallStacksResponseDescriptor = $convert.base64Decode(
    'CiFHZXRPcGVyYXRpb25BQklDYWxsU3RhY2tzUmVzcG9uc2USOwoLY2FsbF9zdGFja3MYASADKA'
    'syGi5tYXNzYS5hcGkudjEuQUJJQ2FsbFN0YWNrUgpjYWxsU3RhY2tz');

@$core.Deprecated('Use getSlotABICallStacksRequestDescriptor instead')
const GetSlotABICallStacksRequest$json = {
  '1': 'GetSlotABICallStacksRequest',
  '2': [
    {'1': 'slots', '3': 1, '4': 3, '5': 11, '6': '.massa.model.v1.Slot', '10': 'slots'},
  ],
};

/// Descriptor for `GetSlotABICallStacksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSlotABICallStacksRequestDescriptor = $convert.base64Decode(
    'ChtHZXRTbG90QUJJQ2FsbFN0YWNrc1JlcXVlc3QSKgoFc2xvdHMYASADKAsyFC5tYXNzYS5tb2'
    'RlbC52MS5TbG90UgVzbG90cw==');

@$core.Deprecated('Use aSCABICallStackDescriptor instead')
const ASCABICallStack$json = {
  '1': 'ASCABICallStack',
  '2': [
    {'1': 'index', '3': 1, '4': 1, '5': 4, '10': 'index'},
    {'1': 'call_stack', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.ABICallStackElementParent', '10': 'callStack'},
  ],
};

/// Descriptor for `ASCABICallStack`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aSCABICallStackDescriptor = $convert.base64Decode(
    'Cg9BU0NBQklDYWxsU3RhY2sSFAoFaW5kZXgYASABKARSBWluZGV4EkYKCmNhbGxfc3RhY2sYAi'
    'ADKAsyJy5tYXNzYS5hcGkudjEuQUJJQ2FsbFN0YWNrRWxlbWVudFBhcmVudFIJY2FsbFN0YWNr');

@$core.Deprecated('Use operationABICallStackDescriptor instead')
const OperationABICallStack$json = {
  '1': 'OperationABICallStack',
  '2': [
    {'1': 'operation_id', '3': 1, '4': 1, '5': 9, '10': 'operationId'},
    {'1': 'call_stack', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.ABICallStackElementParent', '10': 'callStack'},
  ],
...
/// Descriptor for `OperationABICallStack`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List operationABICallStackDescriptor = $convert.base64Decode(
    'ChVPcGVyYXRpb25BQklDYWxsU3RhY2sSIQoMb3BlcmF0aW9uX2lkGAEgASgJUgtvcGVyYXRpb2'
    '5JZBJGCgpjYWxsX3N0YWNrGAIgAygLMicubWFzc2EuYXBpLnYxLkFCSUNhbGxTdGFja0VsZW1l'
    'bnRQYXJlbnRSCWNhbGxTdGFjaw==');

@$core.Deprecated('Use slotABICallStacksDescriptor instead')
const SlotABICallStacks$json = {
  '1': 'SlotABICallStacks',
  '2': [
    {'1': 'asc_call_stacks', '3': 1, '4': 3, '5': 11, '6': '.massa.api.v1.ASCABICallStack', '10': 'ascCallStacks'},
    {'1': 'operation_call_stacks', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.OperationABICallStack', '10': 'operationCallStacks'},
  ],
};

/// Descriptor for `SlotABICallStacks`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List slotABICallStacksDescriptor = $convert.base64Decode(
    'ChFTbG90QUJJQ2FsbFN0YWNrcxJFCg9hc2NfY2FsbF9zdGFja3MYASADKAsyHS5tYXNzYS5hcG'
    'kudjEuQVNDQUJJQ2FsbFN0YWNrUg1hc2NDYWxsU3RhY2tzElcKFW9wZXJhdGlvbl9jYWxsX3N0'
    'YWNrcxgCIAMoCzIjLm1hc3NhLmFwaS52MS5PcGVyYXRpb25BQklDYWxsU3RhY2tSE29wZXJhdG'
    'lvbkNhbGxTdGFja3M=');

@$core.Deprecated('Use getSlotABICallStacksResponseDescriptor instead')
const GetSlotABICallStacksResponse$json = {
  '1': 'GetSlotABICallStacksResponse',
  '2': [
    {'1': 'slot_call_stacks', '3': 1, '4': 3, '5': 11, '6': '.massa.api.v1.SlotABICallStacks', '10': 'slotCallStacks'},
  ],
};

/// Descriptor for `GetSlotABICallStacksResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSlotABICallStacksResponseDescriptor = $convert.base64Decode(
    'ChxHZXRTbG90QUJJQ2FsbFN0YWNrc1Jlc3BvbnNlEkkKEHNsb3RfY2FsbF9zdGFja3MYASADKA'
    'syHy5tYXNzYS5hcGkudjEuU2xvdEFCSUNhbGxTdGFja3NSDnNsb3RDYWxsU3RhY2tz');

@$core.Deprecated('Use getSlotTransfersRequestDescriptor instead')
const GetSlotTransfersRequest$json = {
  '1': 'GetSlotTransfersRequest',
  '2': [
    {'1': 'slots', '3': 1, '4': 3, '5': 11, '6': '.massa.model.v1.Slot', '10': 'slots'},
  ],
};

/// Descriptor for `GetSlotTransfersRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSlotTransfersRequestDescriptor = $convert.base64Decode(
    'ChdHZXRTbG90VHJhbnNmZXJzUmVxdWVzdBIqCgVzbG90cxgBIAMoCzIULm1hc3NhLm1vZGVsLn'
    'YxLlNsb3RSBXNsb3Rz');
...
const TransferInfo$json = {
  ...
  '2': [
    ...
    {'1': 'operation_id', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'operationId'},
    {'1': 'asc_index', '3': 5, '4': 1, '5': 4, '9': 0, '10': 'ascIndex'},
  ],
  '8': [
    {'1': 'operation_id_or_asc_index'},
  ],
};
...
final $typed_data.Uint8List transferInfoDescriptor = $convert.base64Decode(
    'CgxUcmFuc2ZlckluZm8SEgoEZnJvbRgBIAEoCVIEZnJvbRIOCgJ0bxgCIAEoCVICdG8SFgoGYW'
    '1vdW50GAMgASgEUgZhbW91bnQSIwoMb3BlcmF0aW9uX2lkGAQgASgJSABSC29wZXJhdGlvbklk'
    'Eh0KCWFzY19pbmRleBgFIAEoBEgAUghhc2NJbmRleEIbChlvcGVyYXRpb25faWRfb3JfYXNjX2'
    'luZGV4');

@$core.Deprecated('Use transferInfosDescriptor instead')
const TransferInfos$json = {
  '1': 'TransferInfos',
  '2': [
    {'1': 'slot', '3': 1, '4': 1, '5': 11, '6': '.massa.model.v1.Slot', '10': 'slot'},
    {'1': 'transfers', '3': 2, '4': 3, '5': 11, '6': '.massa.api.v1.TransferInfo', '10': 'transfers'},
...
/// Descriptor for `TransferInfos`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List transferInfosDescriptor = $convert.base64Decode(
    'Cg1UcmFuc2ZlckluZm9zEigKBHNsb3QYASABKAsyFC5tYXNzYS5tb2RlbC52MS5TbG90UgRzbG'
    '90EjgKCXRyYW5zZmVycxgCIAMoCzIaLm1hc3NhLmFwaS52MS5UcmFuc2ZlckluZm9SCXRyYW5z'
    'ZmVycw==');

@$core.Deprecated('Use getSlotTransfersResponseDescriptor instead')
const GetSlotTransfersResponse$json = {
  '1': 'GetSlotTransfersResponse',
  '2': [
    {'1': 'transfer_each_slot', '3': 1, '4': 3, '5': 11, '6': '.massa.api.v1.TransferInfos', '10': 'transferEachSlot'},
  ],
};

/// Descriptor for `GetSlotTransfersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSlotTransfersResponseDescriptor = $convert.base64Decode(
    'ChhHZXRTbG90VHJhbnNmZXJzUmVzcG9uc2USSQoSdHJhbnNmZXJfZWFjaF9zbG90GAEgAygLMh'
    'subWFzc2EuYXBpLnYxLlRyYW5zZmVySW5mb3NSEHRyYW5zZmVyRWFjaFNsb3Q=');
