...
const ExecutionQueryExecutionStatus$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'EXECUTION_QUERY_EXECUTION_STATUS_EXECUTABLE_OR_EXPIRED',
      '2': 3
    },
  ],
};
...
final $typed_data.Uint8List executionQueryExecutionStatusDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List executeReadOnlyCallRequestDescriptor =
    $convert.base64Decode(
        'ChpFeGVjdXRlUmVhZE9ubHlDYWxsUmVxdWVzdBI5CgRjYWxsGAEgASgLMiUubWFzc2EubW9kZWwudjEuUmVhZE9ubHlFeGVjdXRpb25DYWxsUgRjYWxs');
...
final $typed_data.Uint8List executeReadOnlyCallResponseDescriptor =
    $convert.base64Decode(
        'ChtFeGVjdXRlUmVhZE9ubHlDYWxsUmVzcG9uc2USPwoGb3V0cHV0GAEgASgLMicubWFzc2EubW9kZWwudjEuUmVhZE9ubHlFeGVjdXRpb25PdXRwdXRSBm91dHB1dA==');
...
final $typed_data.Uint8List getBlocksResponseDescriptor = $convert.base64Decode(
    'ChFHZXRCbG9ja3NSZXNwb25zZRJDCg53cmFwcGVkX2Jsb2NrcxgBIAMoCzIcLm1hc3NhLm1vZGVsLnYxLkJsb2NrV3JhcHBlclINd3JhcHBlZEJsb2Nrcw==');
...
final $typed_data.Uint8List getDatastoreEntriesRequestDescriptor =
    $convert.base64Decode(
        'ChpHZXREYXRhc3RvcmVFbnRyaWVzUmVxdWVzdBI/CgdmaWx0ZXJzGAEgAygLMiUubWFzc2EuYXBpLnYxLkdldERhdGFzdG9yZUVudHJ5RmlsdGVyUgdmaWx0ZXJz');
...
final $typed_data.Uint8List getDatastoreEntryFilterDescriptor =
    $convert.base64Decode(
        'ChdHZXREYXRhc3RvcmVFbnRyeUZpbHRlchJCCgthZGRyZXNzX2tleRgBIAEoCzIfLm1hc3NhLm1vZGVsLnYxLkFkZHJlc3NLZXlFbnRyeUgAUgphZGRyZXNzS2V5QggKBmZpbHRlcg==');
...
final $typed_data.Uint8List getDatastoreEntriesResponseDescriptor =
    $convert.base64Decode(
        'ChtHZXREYXRhc3RvcmVFbnRyaWVzUmVzcG9uc2USSwoRZGF0YXN0b3JlX2VudHJpZXMYASADKAsyHi5tYXNzYS5tb2RlbC52MS5EYXRhc3RvcmVFbnRyeVIQZGF0YXN0b3JlRW50cmllcw==');
...
final $typed_data.Uint8List getEndorsementsRequestDescriptor =
    $convert.base64Decode(
        'ChZHZXRFbmRvcnNlbWVudHNSZXF1ZXN0EicKD2VuZG9yc2VtZW50X2lkcxgBIAMoCVIOZW5kb3JzZW1lbnRJZHM=');
...
final $typed_data.Uint8List getEndorsementsResponseDescriptor =
    $convert.base64Decode(
        'ChdHZXRFbmRvcnNlbWVudHNSZXNwb25zZRJVChR3cmFwcGVkX2VuZG9yc2VtZW50cxgBIAMoCzIiLm1hc3NhLm1vZGVsLnYxLkVuZG9yc2VtZW50V3JhcHBlclITd3JhcHBlZEVuZG9yc2VtZW50cw==');
...
final $typed_data.Uint8List getNextBlockBestParentsResponseDescriptor =
    $convert.base64Decode(
        'Ch9HZXROZXh0QmxvY2tCZXN0UGFyZW50c1Jlc3BvbnNlEkAKDWJsb2NrX3BhcmVudHMYASADKAsyGy5tYXNzYS5tb2RlbC52MS5CbG9ja1BhcmVudFIMYmxvY2tQYXJlbnRz');
...
final $typed_data.Uint8List getOperationsRequestDescriptor = $convert.base64Decode(
    'ChRHZXRPcGVyYXRpb25zUmVxdWVzdBIjCg1vcGVyYXRpb25faWRzGAEgAygJUgxvcGVyYXRpb25JZHM=');
...
final $typed_data.Uint8List getOperationsResponseDescriptor = $convert.base64Decode(
    'ChVHZXRPcGVyYXRpb25zUmVzcG9uc2USTwoSd3JhcHBlZF9vcGVyYXRpb25zGAEgAygLMiAubWFzc2EubW9kZWwudjEuT3BlcmF0aW9uV3JhcHBlclIRd3JhcHBlZE9wZXJhdGlvbnM=');
...
final $typed_data.Uint8List getScExecutionEventsRequestDescriptor =
    $convert.base64Decode(
        'ChtHZXRTY0V4ZWN1dGlvbkV2ZW50c1JlcXVlc3QSPwoHZmlsdGVycxgBIAMoCzIlLm1hc3NhLmFwaS52MS5TY0V4ZWN1dGlvbkV2ZW50c0ZpbHRlclIHZmlsdGVycw==');
...
final $typed_data.Uint8List scExecutionEventsFilterDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List getScExecutionEventsResponseDescriptor =
    $convert.base64Decode(
        'ChxHZXRTY0V4ZWN1dGlvbkV2ZW50c1Jlc3BvbnNlEjgKBmV2ZW50cxgBIAMoCzIgLm1hc3NhLm1vZGVsLnYxLlNjRXhlY3V0aW9uRXZlbnRSBmV2ZW50cw==');
...
final $typed_data.Uint8List getStatusResponseDescriptor = $convert.base64Decode(
    'ChFHZXRTdGF0dXNSZXNwb25zZRI0CgZzdGF0dXMYASABKAsyHC5tYXNzYS5tb2RlbC52MS5QdWJsaWNTdGF0dXNSBnN0YXR1cw==');
...
final $typed_data.Uint8List getSelectorDrawsRequestDescriptor =
    $convert.base64Decode(
        'ChdHZXRTZWxlY3RvckRyYXdzUmVxdWVzdBI7CgdmaWx0ZXJzGAEgAygLMiEubWFzc2EuYXBpLnYxLlNlbGVjdG9yRHJhd3NGaWx0ZXJSB2ZpbHRlcnM=');
...
final $typed_data.Uint8List selectorDrawsFilterDescriptor = $convert.base64Decode(
    'ChNTZWxlY3RvckRyYXdzRmlsdGVyEjkKCWFkZHJlc3NlcxgBIAEoCzIZLm1hc3NhLm1vZGVsLnYxLkFkZHJlc3Nlc0gAUglhZGRyZXNzZXMSOgoKc2xvdF9yYW5nZRgCIAEoCzIZLm1hc3NhLm1vZGVsLnYxLlNsb3RSYW5nZUgAUglzbG90UmFuZ2VCCAoGZmlsdGVy');
...
final $typed_data.Uint8List getSelectorDrawsResponseDescriptor =
    $convert.base64Decode(
        'ChhHZXRTZWxlY3RvckRyYXdzUmVzcG9uc2USLgoFZHJhd3MYASADKAsyGC5tYXNzYS5tb2RlbC52MS5TbG90RHJhd1IFZHJhd3M=');
...
final $typed_data.Uint8List getStakersRequestDescriptor = $convert.base64Decode(
    'ChFHZXRTdGFrZXJzUmVxdWVzdBI1CgdmaWx0ZXJzGAEgAygLMhsubWFzc2EuYXBpLnYxLlN0YWtlcnNGaWx0ZXJSB2ZpbHRlcnM=');
...
final $typed_data.Uint8List stakersFilterDescriptor = $convert.base64Decode(
    'Cg1TdGFrZXJzRmlsdGVyEh0KCW1pbl9yb2xscxgBIAEoBEgAUghtaW5Sb2xscxIdCgltYXhfcm9sbHMYAiABKARIAFIIbWF4Um9sbHMSFgoFbGltaXQYAyABKARIAFIFbGltaXRCCAoGZmlsdGVy');
...
final $typed_data.Uint8List getStakersResponseDescriptor = $convert.base64Decode(
    'ChJHZXRTdGFrZXJzUmVzcG9uc2USNQoHc3Rha2VycxgBIAMoCzIbLm1hc3NhLm1vZGVsLnYxLlN0YWtlckVudHJ5UgdzdGFrZXJz');
...
final $typed_data.Uint8List getTransactionsThroughputResponseDescriptor =
    $convert.base64Decode(
        'CiFHZXRUcmFuc2FjdGlvbnNUaHJvdWdocHV0UmVzcG9uc2USHgoKdGhyb3VnaHB1dBgBIAEoDVIKdGhyb3VnaHB1dA==');
...
final $typed_data.Uint8List queryStateRequestDescriptor = $convert.base64Decode(
    'ChFRdWVyeVN0YXRlUmVxdWVzdBJBCgdxdWVyaWVzGAEgAygLMicubWFzc2EuYXBpLnYxLkV4ZWN1dGlvblF1ZXJ5UmVxdWVzdEl0ZW1SB3F1ZXJpZXM=');
...
final $typed_data.Uint8List executionQueryRequestItemDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List addressDatastoreKeysCandidateDescriptor =
    $convert.base64Decode(
        'Ch1BZGRyZXNzRGF0YXN0b3JlS2V5c0NhbmRpZGF0ZRIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEhYKBnByZWZpeBgCIAEoDFIGcHJlZml4');
...
final $typed_data.Uint8List addressDatastoreKeysFinalDescriptor =
    $convert.base64Decode(
        'ChlBZGRyZXNzRGF0YXN0b3JlS2V5c0ZpbmFsEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSFgoGcHJlZml4GAIgASgMUgZwcmVmaXg=');
...
final $typed_data.Uint8List addressDatastoreValueCandidateDescriptor =
    $convert.base64Decode(
        'Ch5BZGRyZXNzRGF0YXN0b3JlVmFsdWVDYW5kaWRhdGUSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxIQCgNrZXkYAiABKAxSA2tleQ==');
...
final $typed_data.Uint8List addressDatastoreValueFinalDescriptor =
    $convert.base64Decode(
        'ChpBZGRyZXNzRGF0YXN0b3JlVmFsdWVGaW5hbBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEhAKA2tleRgCIAEoDFIDa2V5');
...
final $typed_data.Uint8List opExecutionStatusCandidateDescriptor =
    $convert.base64Decode(
        'ChpPcEV4ZWN1dGlvblN0YXR1c0NhbmRpZGF0ZRIhCgxvcGVyYXRpb25faWQYASABKAlSC29wZXJhdGlvbklk');
...
final $typed_data.Uint8List opExecutionStatusFinalDescriptor =
    $convert.base64Decode(
        'ChZPcEV4ZWN1dGlvblN0YXR1c0ZpbmFsEiEKDG9wZXJhdGlvbl9pZBgBIAEoCVILb3BlcmF0aW9uSWQ=');
...
final $typed_data.Uint8List denunciationExecutionStatusCandidateDescriptor =
    $convert.base64Decode(
        'CiREZW51bmNpYXRpb25FeGVjdXRpb25TdGF0dXNDYW5kaWRhdGUSUAoSZGVudW5jaWF0aW9uX2luZGV4GAEgASgLMiEubWFzc2EubW9kZWwudjEuRGVudW5jaWF0aW9uSW5kZXhSEWRlbnVuY2lhdGlvbkluZGV4');
...
final $typed_data.Uint8List denunciationExecutionStatusFinalDescriptor =
    $convert.base64Decode(
        'CiBEZW51bmNpYXRpb25FeGVjdXRpb25TdGF0dXNGaW5hbBJQChJkZW51bmNpYXRpb25faW5kZXgYASABKAsyIS5tYXNzYS5tb2RlbC52MS5EZW51bmNpYXRpb25JbmRleFIRZGVudW5jaWF0aW9uSW5kZXg=');
...
final $typed_data.Uint8List addressDeferredCreditsCandidateDescriptor =
    $convert.base64Decode(
        'Ch9BZGRyZXNzRGVmZXJyZWRDcmVkaXRzQ2FuZGlkYXRlEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3M=');
...
final $typed_data.Uint8List cycleInfosDescriptor = $convert.base64Decode(
    'CgpDeWNsZUluZm9zEhQKBWN5Y2xlGAEgASgEUgVjeWNsZRIyChVyZXN0cmljdF90b19hZGRyZXNzZXMYAiADKAlSE3Jlc3RyaWN0VG9BZGRyZXNzZXM=');
...
final $typed_data.Uint8List eventsDescriptor = $convert.base64Decode(
    'CgZFdmVudHMSPwoHZmlsdGVycxgBIAMoCzIlLm1hc3NhLmFwaS52MS5TY0V4ZWN1dGlvbkV2ZW50c0ZpbHRlclIHZmlsdGVycw==');
...
final $typed_data.Uint8List queryStateResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List executionQueryResponseDescriptor =
    $convert.base64Decode(
        'ChZFeGVjdXRpb25RdWVyeVJlc3BvbnNlEkIKBnJlc3VsdBgBIAEoCzIoLm1hc3NhLmFwaS52MS5FeGVjdXRpb25RdWVyeVJlc3BvbnNlSXRlbUgAUgZyZXN1bHQSLQoFZXJyb3IYAiABKAsyFS5tYXNzYS5tb2RlbC52MS5FcnJvckgAUgVlcnJvckIKCghyZXNwb25zZQ==');
...
final $typed_data.Uint8List executionQueryResponseItemDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List deferredCreditsEntryWrapperDescriptor =
    $convert.base64Decode(
        'ChtEZWZlcnJlZENyZWRpdHNFbnRyeVdyYXBwZXISPAoHZW50cmllcxgBIAMoCzIiLm1hc3NhLmFwaS52MS5EZWZlcnJlZENyZWRpdHNFbnRyeVIHZW50cmllcw==');
...
final $typed_data.Uint8List deferredCreditsEntryDescriptor = $convert.base64Decode(
    'ChREZWZlcnJlZENyZWRpdHNFbnRyeRIoCgRzbG90GAEgASgLMhQubWFzc2EubW9kZWwudjEuU2xvdFIEc2xvdBI0CgZhbW91bnQYAiABKAsyHC5tYXNzYS5tb2RlbC52MS5OYXRpdmVBbW91bnRSBmFtb3VudA==');
...
final $typed_data.Uint8List executionQueryCycleInfosDescriptor =
    $convert.base64Decode(
        'ChhFeGVjdXRpb25RdWVyeUN5Y2xlSW5mb3MSFAoFY3ljbGUYASABKARSBWN5Y2xlEhkKCGlzX2ZpbmFsGAIgASgIUgdpc0ZpbmFsEk4KDHN0YWtlcl9pbmZvcxgDIAMoCzIrLm1hc3NhLmFwaS52MS5FeGVjdXRpb25RdWVyeVN0YWtlckluZm9FbnRyeVILc3Rha2VySW5mb3M=');
...
final $typed_data.Uint8List executionQueryStakerInfoEntryDescriptor =
    $convert.base64Decode(
        'Ch1FeGVjdXRpb25RdWVyeVN0YWtlckluZm9FbnRyeRIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEjoKBGluZm8YAiABKAsyJi5tYXNzYS5hcGkudjEuRXhlY3V0aW9uUXVlcnlTdGFrZXJJbmZvUgRpbmZv');
...
final $typed_data.Uint8List executionQueryStakerInfoDescriptor =
    $convert.base64Decode(
        'ChhFeGVjdXRpb25RdWVyeVN0YWtlckluZm8SIQoMYWN0aXZlX3JvbGxzGAEgASgEUgthY3RpdmVSb2xscxJlChBwcm9kdWN0aW9uX3N0YXRzGAIgASgLMjoubWFzc2EuYXBpLnYxLkV4ZWN1dGlvblF1ZXJ5U3Rha2VySW5mb1Byb2R1Y3Rpb25TdGF0c0VudHJ5Ug9wcm9kdWN0aW9uU3RhdHM=');
@$core.Deprecated(
...
final $typed_data.Uint8List
    ...
    $convert.base64Decode(
        'CixFeGVjdXRpb25RdWVyeVN0YWtlckluZm9Qcm9kdWN0aW9uU3RhdHNFbnRyeRIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEksKBXN0YXRzGAIgASgLMjUubWFzc2EuYXBpLnYxLkV4ZWN1dGlvblF1ZXJ5U3Rha2VySW5mb1Byb2R1Y3Rpb25TdGF0c1IFc3RhdHM=');
@$core
...
final $typed_data.Uint8List executionQueryStakerInfoProductionStatsDescriptor =
    $convert.base64Decode(
        'CidFeGVjdXRpb25RdWVyeVN0YWtlckluZm9Qcm9kdWN0aW9uU3RhdHMSLgoTYmxvY2tfc3VjY2Vzc19jb3VudBgBIAEoBFIRYmxvY2tTdWNjZXNzQ291bnQSLgoTYmxvY2tfZmFpbHVyZV9jb3VudBgCIAEoBFIRYmxvY2tGYWlsdXJlQ291bnQ=');
...
final $typed_data.Uint8List scOutputEventsWrapperDescriptor = $convert.base64Decode(
    'ChVTY091dHB1dEV2ZW50c1dyYXBwZXISOAoGZXZlbnRzGAEgAygLMiAubWFzc2EubW9kZWwudjEuU2NFeGVjdXRpb25FdmVudFIGZXZlbnRz');
...
final $typed_data.Uint8List newBlocksRequestDescriptor =
    $convert.base64Decode('ChBOZXdCbG9ja3NSZXF1ZXN0');
...
final $typed_data.Uint8List newBlocksResponseDescriptor = $convert.base64Decode(
    'ChFOZXdCbG9ja3NSZXNwb25zZRI+CgxzaWduZWRfYmxvY2sYASABKAsyGy5tYXNzYS5tb2RlbC52MS5TaWduZWRCbG9ja1ILc2lnbmVkQmxvY2s=');
...
final $typed_data.Uint8List newBlocksHeadersRequestDescriptor =
    $convert.base64Decode('ChdOZXdCbG9ja3NIZWFkZXJzUmVxdWVzdA==');
...
final $typed_data.Uint8List newBlocksHeadersResponseDescriptor =
    $convert.base64Decode(
        'ChhOZXdCbG9ja3NIZWFkZXJzUmVzcG9uc2USUQoTc2lnbmVkX2Jsb2NrX2hlYWRlchgBIAEoCzIhLm1hc3NhLm1vZGVsLnYxLlNpZ25lZEJsb2NrSGVhZGVyUhFzaWduZWRCbG9ja0hlYWRlcg==');
...
final $typed_data.Uint8List newEndorsementsRequestDescriptor =
    $convert.base64Decode('ChZOZXdFbmRvcnNlbWVudHNSZXF1ZXN0');
...
final $typed_data.Uint8List newEndorsementsResponseDescriptor =
    $convert.base64Decode(
        'ChdOZXdFbmRvcnNlbWVudHNSZXNwb25zZRJQChJzaWduZWRfZW5kb3JzZW1lbnQYASABKAsyIS5tYXNzYS5tb2RlbC52MS5TaWduZWRFbmRvcnNlbWVudFIRc2lnbmVkRW5kb3JzZW1lbnQ=');
...
final $typed_data.Uint8List newFilledBlocksRequestDescriptor =
    $convert.base64Decode('ChZOZXdGaWxsZWRCbG9ja3NSZXF1ZXN0');
...
final $typed_data.Uint8List newFilledBlocksResponseDescriptor =
    $convert.base64Decode(
        'ChdOZXdGaWxsZWRCbG9ja3NSZXNwb25zZRI+CgxmaWxsZWRfYmxvY2sYASABKAsyGy5tYXNzYS5tb2RlbC52MS5GaWxsZWRCbG9ja1ILZmlsbGVkQmxvY2s=');
...
final $typed_data.Uint8List newOperationsRequestDescriptor = $convert.base64Decode(
    'ChROZXdPcGVyYXRpb25zUmVxdWVzdBI7CgdmaWx0ZXJzGAEgAygLMiEubWFzc2EuYXBpLnYxLk5ld09wZXJhdGlvbnNGaWx0ZXJSB2ZpbHRlcnM=');
...
final $typed_data.Uint8List newOperationsFilterDescriptor = $convert.base64Decode(
    'ChNOZXdPcGVyYXRpb25zRmlsdGVyEkAKD29wZXJhdGlvbl90eXBlcxgCIAEoCzIXLm1hc3NhLm1vZGVsLnYxLk9wVHlwZXNSDm9wZXJhdGlvblR5cGVz');
...
final $typed_data.Uint8List newOperationsResponseDescriptor = $convert.base64Decode(
    'ChVOZXdPcGVyYXRpb25zUmVzcG9uc2USSgoQc2lnbmVkX29wZXJhdGlvbhgBIAEoCzIfLm1hc3NhLm1vZGVsLnYxLlNpZ25lZE9wZXJhdGlvblIPc2lnbmVkT3BlcmF0aW9u');
...
final $typed_data.Uint8List newSlotExecutionOutputsRequestDescriptor =
    $convert.base64Decode(
        'Ch5OZXdTbG90RXhlY3V0aW9uT3V0cHV0c1JlcXVlc3QSRQoHZmlsdGVycxgBIAMoCzIrLm1hc3NhLmFwaS52MS5OZXdTbG90RXhlY3V0aW9uT3V0cHV0c0ZpbHRlclIHZmlsdGVycw==');
...
final $typed_data.Uint8List newSlotExecutionOutputsFilterDescriptor =
    $convert.base64Decode(
        'Ch1OZXdTbG90RXhlY3V0aW9uT3V0cHV0c0ZpbHRlchI/CgZzdGF0dXMYASABKA4yJS5tYXNzYS5tb2RlbC52MS5FeGVjdXRpb25PdXRwdXRTdGF0dXNIAFIGc3RhdHVzQggKBmZpbHRlcg==');
...
final $typed_data.Uint8List newSlotExecutionOutputsResponseDescriptor =
    $convert.base64Decode(
        'Ch9OZXdTbG90RXhlY3V0aW9uT3V0cHV0c1Jlc3BvbnNlEjsKBm91dHB1dBgBIAEoCzIjLm1hc3NhLm1vZGVsLnYxLlNsb3RFeGVjdXRpb25PdXRwdXRSBm91dHB1dA==');
...
final $typed_data.Uint8List sendBlocksRequestDescriptor = $convert.base64Decode(
    'ChFTZW5kQmxvY2tzUmVxdWVzdBIxCgVibG9jaxgBIAEoCzIbLm1hc3NhLm1vZGVsLnYxLlNlY3VyZVNoYXJlUgVibG9jaw==');
...
final $typed_data.Uint8List sendBlocksResponseDescriptor = $convert.base64Decode(
    'ChJTZW5kQmxvY2tzUmVzcG9uc2USGwoIYmxvY2tfaWQYASABKAlIAFIHYmxvY2tJZBItCgVlcnJvchgCIAEoCzIVLm1hc3NhLm1vZGVsLnYxLkVycm9ySABSBWVycm9yQggKBnJlc3VsdA==');
...
final $typed_data.Uint8List sendEndorsementsRequestDescriptor =
    $convert.base64Decode(
        'ChdTZW5kRW5kb3JzZW1lbnRzUmVxdWVzdBI/CgxlbmRvcnNlbWVudHMYASADKAsyGy5tYXNzYS5tb2RlbC52MS5TZWN1cmVTaGFyZVIMZW5kb3JzZW1lbnRz');
...
final $typed_data.Uint8List sendEndorsementsResponseDescriptor =
    $convert.base64Decode(
        'ChhTZW5kRW5kb3JzZW1lbnRzUmVzcG9uc2USSwoQZW5kb3JzZW1lbnRzX2lkcxgBIAEoCzIeLm1hc3NhLm1vZGVsLnYxLkVuZG9yc2VtZW50SWRzSABSD2VuZG9yc2VtZW50c0lkcxItCgVlcnJvchgCIAEoCzIVLm1hc3NhLm1vZGVsLnYxLkVycm9ySABSBWVycm9yQggKBnJlc3VsdA==');
...
final $typed_data.Uint8List sendOperationsRequestDescriptor = $convert.base64Decode(
    'ChVTZW5kT3BlcmF0aW9uc1JlcXVlc3QSOwoKb3BlcmF0aW9ucxgBIAMoCzIbLm1hc3NhLm1vZGVsLnYxLlNlY3VyZVNoYXJlUgpvcGVyYXRpb25z');
...
final $typed_data.Uint8List sendOperationsResponseDescriptor =
    $convert.base64Decode(
        'ChZTZW5kT3BlcmF0aW9uc1Jlc3BvbnNlEkUKDm9wZXJhdGlvbnNfaWRzGAEgASgLMhwubWFzc2EubW9kZWwudjEuT3BlcmF0aW9uSWRzSABSDW9wZXJhdGlvbnNJZHMSLQoFZXJyb3IYAiABKAsyFS5tYXNzYS5tb2RlbC52MS5FcnJvckgAUgVlcnJvckIICgZyZXN1bHQ=');
...
final $typed_data.Uint8List transactionsThroughputRequestDescriptor =
    $convert.base64Decode(
        'Ch1UcmFuc2FjdGlvbnNUaHJvdWdocHV0UmVxdWVzdBI4CghpbnRlcnZhbBgBIAEoCzIcLmdvb2dsZS5wcm90b2J1Zi5VSW50NjRWYWx1ZVIIaW50ZXJ2YWw=');
...
final $typed_data.Uint8List transactionsThroughputResponseDescriptor =
    $convert.base64Decode(
        'Ch5UcmFuc2FjdGlvbnNUaHJvdWdocHV0UmVzcG9uc2USHgoKdGhyb3VnaHB1dBgBIAEoDVIKdGhyb3VnaHB1dA==');
...
final $typed_data.Uint8List searchBlocksRequestDescriptor = $convert.base64Decode(
    'ChNTZWFyY2hCbG9ja3NSZXF1ZXN0EjoKB2ZpbHRlcnMYASADKAsyIC5tYXNzYS5hcGkudjEuU2VhcmNoQmxvY2tzRmlsdGVyUgdmaWx0ZXJz');
...
final $typed_data.Uint8List searchBlocksFilterDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List searchBlocksResponseDescriptor = $convert.base64Decode(
    'ChRTZWFyY2hCbG9ja3NSZXNwb25zZRI6CgtibG9ja19pbmZvcxgBIAMoCzIZLm1hc3NhLm1vZGVsLnYxLkJsb2NrSW5mb1IKYmxvY2tJbmZvcw==');
...
final $typed_data.Uint8List searchEndorsementsRequestDescriptor =
    $convert.base64Decode(
        'ChlTZWFyY2hFbmRvcnNlbWVudHNSZXF1ZXN0EkAKB2ZpbHRlcnMYASADKAsyJi5tYXNzYS5hcGkudjEuU2VhcmNoRW5kb3JzZW1lbnRzRmlsdGVyUgdmaWx0ZXJz');
...
final $typed_data.Uint8List searchEndorsementsFilterDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List searchEndorsementsResponseDescriptor =
    $convert.base64Decode(
        'ChpTZWFyY2hFbmRvcnNlbWVudHNSZXNwb25zZRJMChFlbmRvcnNlbWVudF9pbmZvcxgBIAMoCzIfLm1hc3NhLm1vZGVsLnYxLkVuZG9yc2VtZW50SW5mb1IQZW5kb3JzZW1lbnRJbmZvcw==');
...
final $typed_data.Uint8List searchOperationsRequestDescriptor =
    $convert.base64Decode(
        'ChdTZWFyY2hPcGVyYXRpb25zUmVxdWVzdBI+CgdmaWx0ZXJzGAEgAygLMiQubWFzc2EuYXBpLnYxLlNlYXJjaE9wZXJhdGlvbnNGaWx0ZXJSB2ZpbHRlcnM=');
...
final $typed_data.Uint8List searchOperationsFilterDescriptor =
    $convert.base64Decode(
        'ChZTZWFyY2hPcGVyYXRpb25zRmlsdGVyEkMKDW9wZXJhdGlvbl9pZHMYASABKAsyHC5tYXNzYS5tb2RlbC52MS5PcGVyYXRpb25JZHNIAFIMb3BlcmF0aW9uSWRzEkIKD29wZXJhdGlvbl90eXBlcxgCIAEoCzIXLm1hc3NhLm1vZGVsLnYxLk9wVHlwZXNIAFIOb3BlcmF0aW9uVHlwZXNCCAoGZmlsdGVy');
...
final $typed_data.Uint8List searchOperationsResponseDescriptor =
    $convert.base64Decode(
        'ChhTZWFyY2hPcGVyYXRpb25zUmVzcG9uc2USRgoPb3BlcmF0aW9uX2luZm9zGAEgAygLMh0ubWFzc2EubW9kZWwudjEuT3BlcmF0aW9uSW5mb1IOb3BlcmF0aW9uSW5mb3M=');
