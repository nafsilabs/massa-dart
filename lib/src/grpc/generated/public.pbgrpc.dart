...
class PublicServiceClient extends $grpc.Client {
  ...
  static final _$getOperationABICallStacks = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $1.GetOperationABICallStacksResponse.fromBuffer(value));
  static final _$getSlotABICallStacks = $grpc.ClientMethod<
          $1.GetSlotABICallStacksRequest, $1.GetSlotABICallStacksResponse>(
      '/massa.api.v1.PublicService/GetSlotABICallStacks',
      ($1.GetSlotABICallStacksRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.GetSlotABICallStacksResponse.fromBuffer(value));
  static final _$getSlotTransfers = $grpc.ClientMethod<
          $1.GetSlotTransfersRequest, $1.GetSlotTransfersResponse>(
      '/massa.api.v1.PublicService/GetSlotTransfers',
      ($1.GetSlotTransfersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.GetSlotTransfersResponse.fromBuffer(value));
  ...
  static final _$newSlotABICallStacks = $grpc.ClientMethod<
          $1.NewSlotABICallStacksRequest, $1.NewSlotABICallStacksResponse>(
      '/massa.api.v1.PublicService/NewSlotABICallStacks',
      ($1.NewSlotABICallStacksRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.NewSlotABICallStacksResponse.fromBuffer(value));
  static final _$newSlotTransfers = $grpc.ClientMethod<
          $1.NewSlotTransfersRequest, $1.NewSlotTransfersResponse>(
      '/massa.api.v1.PublicService/NewSlotTransfers',
      ($1.NewSlotTransfersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.NewSlotTransfersResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.GetOperationABICallStacksResponse>
      getOperationABICallStacks($1.GetOperationABICallStacksRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getOperationABICallStacks, request,
        options: options);
  }

  $grpc.ResponseFuture<$1.GetSlotABICallStacksResponse> getSlotABICallStacks(
      $1.GetSlotABICallStacksRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSlotABICallStacks, request, options: options);
  }

  $grpc.ResponseFuture<$1.GetSlotTransfersResponse> getSlotTransfers(
      $1.GetSlotTransfersRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$1.NewSlotABICallStacksResponse> newSlotABICallStacks(
      $async.Stream<$1.NewSlotABICallStacksRequest> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$newSlotABICallStacks, request,
        options: options);
  }

  $grpc.ResponseStream<$1.NewSlotTransfersResponse> newSlotTransfers(
      $async.Stream<$1.NewSlotTransfersRequest> request,
      {$grpc.CallOptions? options}) {
...
abstract class PublicServiceBase extends $grpc.Service {
  ...
  PublicServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.GetOperationABICallStacksRequest,
            $1.GetOperationABICallStacksResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.GetOperationABICallStacksRequest.fromBuffer(value),
        ($1.GetOperationABICallStacksResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetSlotABICallStacksRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.GetSlotABICallStacksRequest.fromBuffer(value),
        ($1.GetSlotABICallStacksResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetSlotTransfersRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.GetSlotTransfersRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$1.NewSlotABICallStacksRequest,
        ...
        true,
        ($core.List<$core.int> value) =>
            $1.NewSlotABICallStacksRequest.fromBuffer(value),
        ($1.NewSlotABICallStacksResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.NewSlotTransfersRequest,
        ...
        true,
        ($core.List<$core.int> value) =>
            $1.NewSlotTransfersRequest.fromBuffer(value),
  ...
  $async.Future<$1.GetOperationABICallStacksResponse>
      getOperationABICallStacks_Pre($grpc.ServiceCall call,
          $async.Future<$1.GetOperationABICallStacksRequest> request) async {
    return getOperationABICallStacks(call, await request);
  }

  $async.Future<$1.GetSlotABICallStacksResponse> getSlotABICallStacks_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetSlotABICallStacksRequest> request) async {
    return getSlotABICallStacks(call, await request);
  }

  $async.Future<$1.GetSlotTransfersResponse> getSlotTransfers_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetSlotTransfersRequest> request) async {
  ...
  $async.Future<$1.GetOperationABICallStacksResponse> getOperationABICallStacks(
      $grpc.ServiceCall call, $1.GetOperationABICallStacksRequest request);
  $async.Future<$1.GetSlotABICallStacksResponse> getSlotABICallStacks(
      $grpc.ServiceCall call, $1.GetSlotABICallStacksRequest request);
  $async.Future<$1.GetSlotTransfersResponse> getSlotTransfers(
      $grpc.ServiceCall call, $1.GetSlotTransfersRequest request);
  ...
  $async.Stream<$1.NewSlotExecutionOutputsResponse> newSlotExecutionOutputs(
      $grpc.ServiceCall call,
      $async.Stream<$1.NewSlotExecutionOutputsRequest> request);
  $async.Stream<$1.NewSlotABICallStacksResponse> newSlotABICallStacks(
      $grpc.ServiceCall call,
      $async.Stream<$1.NewSlotABICallStacksRequest> request);
  $async.Stream<$1.NewSlotTransfersResponse> newSlotTransfers(
      $grpc.ServiceCall call,
      $async.Stream<$1.NewSlotTransfersRequest> request);
