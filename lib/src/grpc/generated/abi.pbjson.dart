...
final $typed_data.Uint8List respResultDescriptor = $convert.base64Decode(
    ...
    'EmlzQWRkcmVzc0VvYVJlc3VsdBJFCg9jaGFpbl9pZF9yZXN1bHQYPyABKAsyGy5tYXNzYS5hYm'
    'kudjEuQ2hhaW5JZFJlc3VsdEgAUg1jaGFpbklkUmVzdWx0QgUKA3Jlcw==');
...
@$core.Deprecated('Use chainIdRequestDescriptor instead')
const ChainIdRequest$json = {
  '1': 'ChainIdRequest',
};

/// Descriptor for `ChainIdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List chainIdRequestDescriptor =
    $convert.base64Decode('Cg5DaGFpbklkUmVxdWVzdA==');

@$core.Deprecated('Use chainIdResultDescriptor instead')
const ChainIdResult$json = {
  '1': 'ChainIdResult',
  '2': [
...
/// Descriptor for `ChainIdResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List chainIdResultDescriptor =
    $convert.base64Decode('Cg1DaGFpbklkUmVzdWx0Eg4KAmlkGAEgASgEUgJpZA==');
