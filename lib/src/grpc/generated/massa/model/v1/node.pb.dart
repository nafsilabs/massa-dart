...
class NodeStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        17, _omitFieldNames ? '' : 'chainId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
...
class PublicStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CompactConfig>(11, _omitFieldNames ? '' : 'config',
        subBuilder: CompactConfig.create)
    ..a<$fixnum.Int64>(
        12, _omitFieldNames ? '' : 'chainId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$2.NativeAmount>(13, _omitFieldNames ? '' : 'minimalFees',
        subBuilder: $2.NativeAmount.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(13)
  set minimalFees($2.NativeAmount v) {
    setField(13, v);
  }
