...
enum Denunciation_Entry { blockHeader, endorsement, notSet }
...
class Denunciation extends $pb.GeneratedMessage {
  ...
  factory Denunciation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Denunciation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, Denunciation_Entry>
      _Denunciation_EntryByTag = {
    1: Denunciation_Entry.blockHeader,
    2: Denunciation_Entry.endorsement,
    0: Denunciation_Entry.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Denunciation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'massa.model.v1'),
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<BlockHeaderDenunciation>(1, _omitFieldNames ? '' : 'blockHeader',
        subBuilder: BlockHeaderDenunciation.create)
    ..aOM<EndorsementDenunciation>(2, _omitFieldNames ? '' : 'endorsement',
        subBuilder: EndorsementDenunciation.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Denunciation copyWith(void Function(Denunciation) updates) =>
      super.copyWith((message) => updates(message as Denunciation))
          as Denunciation;
  ...
  static $pb.PbList<Denunciation> createRepeated() =>
      $pb.PbList<Denunciation>();
  @$core.pragma('dart2js:noInline')
  static Denunciation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Denunciation>(create);
  ...
  @$pb.TagNumber(1)
  set blockHeader(BlockHeaderDenunciation v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set endorsement(EndorsementDenunciation v) {
    setField(2, v);
  }
...
class BlockHeaderDenunciation extends $pb.GeneratedMessage {
  ...
  factory BlockHeaderDenunciation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BlockHeaderDenunciation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BlockHeaderDenunciation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'massa.model.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BlockHeaderDenunciation clone() =>
      BlockHeaderDenunciation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BlockHeaderDenunciation copyWith(
          void Function(BlockHeaderDenunciation) updates) =>
      super.copyWith((message) => updates(message as BlockHeaderDenunciation))
          as BlockHeaderDenunciation;
  ...
  static $pb.PbList<BlockHeaderDenunciation> createRepeated() =>
      $pb.PbList<BlockHeaderDenunciation>();
  @$core.pragma('dart2js:noInline')
  static BlockHeaderDenunciation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BlockHeaderDenunciation>(create);
...
class EndorsementDenunciation extends $pb.GeneratedMessage {
  ...
  factory EndorsementDenunciation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EndorsementDenunciation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EndorsementDenunciation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'massa.model.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'publicKey')
    ..aOM<$5.Slot>(2, _omitFieldNames ? '' : 'slot', subBuilder: $5.Slot.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  EndorsementDenunciation clone() =>
      EndorsementDenunciation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EndorsementDenunciation copyWith(
          void Function(EndorsementDenunciation) updates) =>
      super.copyWith((message) => updates(message as EndorsementDenunciation))
          as EndorsementDenunciation;
  ...
  static $pb.PbList<EndorsementDenunciation> createRepeated() =>
      $pb.PbList<EndorsementDenunciation>();
  @$core.pragma('dart2js:noInline')
  static EndorsementDenunciation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EndorsementDenunciation>(create);
