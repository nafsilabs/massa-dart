...
const MipInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start', '3': 3, '4': 1, '5': 11, '6': '.massa.model.v1.NativeTime', '10': 'start'},
    const {'1': 'timeout', '3': 4, '4': 1, '5': 11, '6': '.massa.model.v1.NativeTime', '10': 'timeout'},
    const {'1': 'activation_delay', '3': 5, '4': 1, '5': 11, '6': '.massa.model.v1.NativeTime', '10': 'activationDelay'},
...
final $typed_data.Uint8List mipInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List mipComponentEntryDescriptor = $convert.base64Decode('ChFNaXBDb21wb25lbnRFbnRyeRIwCgRraW5kGAEgASgOMhwubWFzc2EubW9kZWwudjEuTWlwQ29tcG9uZW50UgRraW5kEhgKB3ZlcnNpb24YAiABKA1SB3ZlcnNpb24=');
