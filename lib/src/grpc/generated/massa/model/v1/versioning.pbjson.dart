...
final $typed_data.Uint8List componentStateIdDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List mipComponentDescriptor = $convert.base64Decode(
    'CgxNaXBDb21wb25lbnQSHQoZTUlQX0NPTVBPTkVOVF9VTlNQRUNJRklFRBAAEhkKFU1JUF9DT01QT05FTlRfQUREUkVTUxABEhkKFU1JUF9DT01QT05FTlRfS0VZUEFJUhAC');
...
final $typed_data.Uint8List mipStatusEntryDescriptor = $convert.base64Decode(
    'Cg5NaXBTdGF0dXNFbnRyeRIyCghtaXBfaW5mbxgBIAEoCzIXLm1hc3NhLm1vZGVsLnYxLk1pcEluZm9SB21pcEluZm8SOwoIc3RhdGVfaWQYAiABKA4yIC5tYXNzYS5tb2RlbC52MS5Db21wb25lbnRTdGF0ZUlkUgdzdGF0ZUlk');
...
final $typed_data.Uint8List mipInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List mipComponentEntryDescriptor = $convert.base64Decode(
    'ChFNaXBDb21wb25lbnRFbnRyeRIwCgRraW5kGAEgASgOMhwubWFzc2EubW9kZWwudjEuTWlwQ29tcG9uZW50UgRraW5kEhgKB3ZlcnNpb24YAiABKA1SB3ZlcnNpb24=');
