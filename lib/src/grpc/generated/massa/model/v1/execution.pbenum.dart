...
class LedgerChangeType extends $pb.ProtobufEnum {
  ...
  static const LedgerChangeType LEDGER_CHANGE_TYPE_SET = LedgerChangeType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LEDGER_CHANGE_TYPE_SET');
  static const LedgerChangeType LEDGER_CHANGE_TYPE_UPDATE = LedgerChangeType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LEDGER_CHANGE_TYPE_UPDATE');
  static const LedgerChangeType LEDGER_CHANGE_TYPE_DELETE = LedgerChangeType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
