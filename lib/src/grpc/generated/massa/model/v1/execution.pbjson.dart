...
final $typed_data.Uint8List readOnlyExecutionCallDescriptor = $convert.base64Decode(
    ...
    'NzGAUgASgLMhwuZ29vZ2xlLnByb3RvYnVmLlN0cmluZ1ZhbHVlUg1jYWxsZXJBZGRyZXNzEi4K'
    'A2ZlZRgHIAEoCzIcLm1hc3NhLm1vZGVsLnYxLk5hdGl2ZUFtb3VudFIDZmVlQggKBnRhcmdldA'
    '==');
...
const FunctionCall$json = {
  ...
  '2': [
    ...
    {'1': 'coins', '3': 4, '4': 1, '5': 11, '6': '.massa.model.v1.NativeAmount', '10': 'coins'},
  ],
};
...
final $typed_data.Uint8List functionCallDescriptor = $convert.base64Decode(
    ...
    'KAxSCXBhcmFtZXRlchIyCgVjb2lucxgEIAEoCzIcLm1hc3NhLm1vZGVsLnYxLk5hdGl2ZUFtb3'
    'VudFIFY29pbnM=');
