...
final $typed_data.Uint8List operationStatusDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List operationDescriptor = $convert.base64Decode('CglPcGVyYXRpb24SEAoDZmVlGAEgASgGUgNmZWUSIwoNZXhwaXJlX3BlcmlvZBgCIAEoBlIMZXhwaXJlUGVyaW9kEi0KAm9wGAMgASgLMh0ubWFzc2EubW9kZWwudjEuT3BlcmF0aW9uVHlwZVICb3A=');
@$core.Deprecated('Use operationTypeDescriptor instead')
const OperationType$json = const {
  '1': 'OperationType',
  '2': const [
    const {'1': 'transaction', '3': 1, '4': 1, '5': 11, '6': '.massa.model.v1.Transaction', '10': 'transaction'},
    const {'1': 'roll_buy', '3': 2, '4': 1, '5': 11, '6': '.massa.model.v1.RollBuy', '10': 'rollBuy'},
    const {'1': 'roll_sell', '3': 3, '4': 1, '5': 11, '6': '.massa.model.v1.RollSell', '10': 'rollSell'},
    const {'1': 'execut_sc', '3': 4, '4': 1, '5': 11, '6': '.massa.model.v1.ExecuteSC', '10': 'executSc'},
    const {'1': 'call_sc', '3': 5, '4': 1, '5': 11, '6': '.massa.model.v1.CallSC', '10': 'callSc'},
  ],
};

/// Descriptor for `OperationType`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List operationTypeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List executeSCDescriptor = $convert.base64Decode('CglFeGVjdXRlU0MSEgoEZGF0YRgBIAEoDFIEZGF0YRIbCgltYXhfY29pbnMYAiABKAZSCG1heENvaW5zEhcKB21heF9nYXMYAyABKAZSBm1heEdhcxJACglkYXRhc3RvcmUYBCADKAsyIi5tYXNzYS5tb2RlbC52MS5CeXRlc01hcEZpZWxkRW50cnlSCWRhdGFzdG9yZQ==');
...
final $typed_data.Uint8List signedOperationDescriptor = $convert.base64Decode('');
...
const OperationWrapper$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operation', '3': 6, '4': 1, '5': 11, '6': '.massa.model.v1.SignedOperation', '10': 'operation'},
    const {'1': 'status', '3': 7, '4': 3, '5': 14, '6': '.massa.model.v1.OperationStatus', '10': 'status'},
  ],
};

/// Descriptor for `OperationWrapper`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List operationWrapperDescriptor = $convert.base64Decode('');
