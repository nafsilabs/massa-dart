...
final $typed_data.Uint8List operationDescriptor = $convert.base64Decode(
    'CglPcGVyYXRpb24SLgoDZmVlGAEgASgLMhwubWFzc2EubW9kZWwudjEuTmF0aXZlQW1vdW50UgNmZWUSIwoNZXhwaXJlX3BlcmlvZBgCIAEoBFIMZXhwaXJlUGVyaW9kEi0KAm9wGAMgASgLMh0ubWFzc2EubW9kZWwudjEuT3BlcmF0aW9uVHlwZVICb3A=');
...
final $typed_data.Uint8List operationTypeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    'CgtUcmFuc2FjdGlvbhIrChFyZWNpcGllbnRfYWRkcmVzcxgBIAEoCVIQcmVjaXBpZW50QWRkcmVzcxI0CgZhbW91bnQYAiABKAsyHC5tYXNzYS5tb2RlbC52MS5OYXRpdmVBbW91bnRSBmFtb3VudA==');
...
final $typed_data.Uint8List executeSCDescriptor = $convert.base64Decode(
    'CglFeGVjdXRlU0MSEgoEZGF0YRgBIAEoDFIEZGF0YRIbCgltYXhfY29pbnMYAiABKARSCG1heENvaW5zEhcKB21heF9nYXMYAyABKARSBm1heEdhcxJACglkYXRhc3RvcmUYBCADKAsyIi5tYXNzYS5tb2RlbC52MS5CeXRlc01hcEZpZWxkRW50cnlSCWRhdGFzdG9yZQ==');
...
final $typed_data.Uint8List callSCDescriptor = $convert.base64Decode(
    'CgZDYWxsU0MSHwoLdGFyZ2V0X2FkZHIYASABKAlSCnRhcmdldEFkZHISHwoLdGFyZ2V0X2Z1bmMYAiABKAlSCnRhcmdldEZ1bmMSFAoFcGFyYW0YAyABKAxSBXBhcmFtEhcKB21heF9nYXMYBCABKARSBm1heEdhcxIyCgVjb2lucxgFIAEoCzIcLm1hc3NhLm1vZGVsLnYxLk5hdGl2ZUFtb3VudFIFY29pbnM=');
...
final $typed_data.Uint8List signedOperationDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List operationWrapperDescriptor = $convert.base64Decode(
    'ChBPcGVyYXRpb25XcmFwcGVyEg4KAmlkGAEgASgJUgJpZBIbCglibG9ja19pZHMYAiADKAlSCGJsb2NrSWRzEhYKBnRocmVhZBgDIAEoDVIGdGhyZWFkEj0KCW9wZXJhdGlvbhgEIAEoCzIfLm1hc3NhLm1vZGVsLnYxLlNpZ25lZE9wZXJhdGlvblIJb3BlcmF0aW9u');
...
final $typed_data.Uint8List operationInfoDescriptor = $convert.base64Decode(
    'Cg1PcGVyYXRpb25JbmZvEg4KAmlkGAEgASgJUgJpZBIbCglibG9ja19pZHMYAiADKAlSCGJsb2NrSWRzEhYKBnRocmVhZBgDIAEoDVIGdGhyZWFk');
...
final $typed_data.Uint8List opTypesDescriptor = $convert.base64Decode(
    'CgdPcFR5cGVzEjEKCG9wX3R5cGVzGAEgAygOMhYubWFzc2EubW9kZWwudjEuT3BUeXBlUgdvcFR5cGVz');
