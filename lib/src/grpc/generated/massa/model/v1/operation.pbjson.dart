...
final $typed_data.Uint8List callSCDescriptor = $convert.base64Decode('');
...
const OperationWrapper$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operation', '3': 3, '4': 1, '5': 11, '6': '.massa.model.v1.SignedOperation', '10': 'operation'},
  ],
};

/// Descriptor for `OperationWrapper`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List operationWrapperDescriptor = $convert.base64Decode('ChBPcGVyYXRpb25XcmFwcGVyEhsKCWJsb2NrX2lkcxgBIAMoCVIIYmxvY2tJZHMSFgoGdGhyZWFkGAIgASgNUgZ0aHJlYWQSPQoJb3BlcmF0aW9uGAMgASgLMh8ubWFzc2EubW9kZWwudjEuU2lnbmVkT3BlcmF0aW9uUglvcGVyYXRpb24=');
