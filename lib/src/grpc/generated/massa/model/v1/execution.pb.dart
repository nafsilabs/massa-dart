...
class SlotExecutionOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SlotExecutionOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..pc<ExecutionOutputStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.KE, valueOf: ExecutionOutputStatus.valueOf, enumValues: ExecutionOutputStatus.values, defaultEnumValue: ExecutionOutputStatus.EXECUTION_OUTPUT_STATUS_UNSPECIFIED)
...
class ScExecutionEventContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScExecutionEventContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Slot>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originSlot', subBuilder: $3.Slot.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blockId')
    ..a<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexInSlot', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callStack')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originOperationId')
    ..pc<ScExecutionEventStatus>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.KE, valueOf: ScExecutionEventStatus.valueOf, enumValues: ScExecutionEventStatus.values, defaultEnumValue: ScExecutionEventStatus.SC_EXECUTION_EVENT_STATUS_UNSPECIFIED)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set originSlot($3.Slot v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set indexInSlot($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set originOperationId($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
...
class StateChanges extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StateChanges', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..pc<DenunciationIndex>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executedDenunciationsChanges', $pb.PbFieldType.PM, subBuilder: DenunciationIndex.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.List<DenunciationIndex> get executedDenunciationsChanges => $_getList(3);
}
...
class ExecutedOpsChangeValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutedOpsChangeValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..pc<OperationExecutionStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.KE, valueOf: OperationExecutionStatus.valueOf, enumValues: OperationExecutionStatus.values, defaultEnumValue: OperationExecutionStatus.OPERATION_EXECUTION_STATUS_UNSPECIFIED)
    ..aOM<$3.Slot>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slot', subBuilder: $3.Slot.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set slot($3.Slot v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AsyncPoolChangeValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AsyncPoolChangeValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..aOM<AsyncMessage>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asyncMessage', subBuilder: AsyncMessage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set asyncMessage(AsyncMessage v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AsyncMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AsyncMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..aOM<$3.Slot>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emissionSlot', subBuilder: $3.Slot.create)
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emissionIndex', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..a<$fixnum.Int64>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxGas', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fee', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coins', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$3.Slot>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validityStart', subBuilder: $3.Slot.create)
    ..aOM<$3.Slot>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validityEnd', subBuilder: $3.Slot.create)
    ...
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hash')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set emissionSlot($3.Slot v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(8)
  set coins($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set validityStart($3.Slot v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set validityEnd($3.Slot v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(14)
  set hash($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(14)
...
class AsyncMessageTrigger extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AsyncMessageTrigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datastoreKey', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set datastoreKey($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
...
class LedgerEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LedgerEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'balance', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bytecode', $pb.PbFieldType.OY)
    ..pc<$4.BytesMapFieldEntry>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entries', $pb.PbFieldType.PM, subBuilder: $4.BytesMapFieldEntry.create)
    ..hasRequiredFields = false
  ;
...
class LedgerEntryUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LedgerEntryUpdate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..aOM<SetOrKeepBytecode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bytecode', subBuilder: SetOrKeepBytecode.create)
  ...
  @$pb.TagNumber(2)
  set bytecode(SetOrKeepBytecode v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBytecode() => $_has(1);
  @$pb.TagNumber(2)
  void clearBytecode() => clearField(2);
...
class SetOrKeepBalance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetOrKeepBalance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..e<SetOrKeepType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SetOrKeepType.SET_OR_KEEP_TYPE_UNSPECIFIED, valueOf: SetOrKeepType.valueOf, enumValues: SetOrKeepType.values)
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'balance', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set type(SetOrKeepType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => clearField(1);
...
class SetOrKeepBytecode extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetOrKeepBytecode', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..e<SetOrKeepType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SetOrKeepType.SET_OR_KEEP_TYPE_UNSPECIFIED, valueOf: SetOrKeepType.valueOf, enumValues: SetOrKeepType.values)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bytecode', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  factory SetOrKeepBytecode.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetOrKeepBytecode.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetOrKeepBytecode copyWith(void Function(SetOrKeepBytecode) updates) => super.copyWith((message) => updates(message as SetOrKeepBytecode)) as SetOrKeepBytecode; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SetOrKeepBytecode create() => SetOrKeepBytecode._();
  SetOrKeepBytecode createEmptyInstance() => create();
  static $pb.PbList<SetOrKeepBytecode> createRepeated() => $pb.PbList<SetOrKeepBytecode>();
  @$core.pragma('dart2js:noInline')
  static SetOrKeepBytecode getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetOrKeepBytecode>(create);
...
class SetOrDeleteDatastoreEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetOrDeleteDatastoreEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..e<SetOrDeleteType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SetOrDeleteType.SET_OR_DELETE_TYPE_UNSPECIFIED, valueOf: SetOrDeleteType.valueOf, enumValues: SetOrDeleteType.values)
    ..aOM<$4.BytesMapFieldEntry>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datastoreEntry', subBuilder: $4.BytesMapFieldEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set type(SetOrDeleteType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => clearField(1);
  ...
  @$pb.TagNumber(2)
  set datastoreEntry($4.BytesMapFieldEntry v) { setField(2, v); }
  @$pb.TagNumber(2)
