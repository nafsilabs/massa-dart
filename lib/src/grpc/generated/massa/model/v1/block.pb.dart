...
class BlockHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$13.Denunciation>(
        7, _omitFieldNames ? '' : 'denunciations', $pb.PbFieldType.PM,
        subBuilder: $13.Denunciation.create)
    ..hasRequiredFields = false;
...
class FilledOperationEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$14.SignedOperation>(2, _omitFieldNames ? '' : 'operation',
  ...
  @$pb.TagNumber(2)
  set operation($14.SignedOperation v) {
    setField(2, v);
  }
