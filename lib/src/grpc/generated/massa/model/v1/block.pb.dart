...
class BlockWrapper extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BlockWrapper', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ...
    ..e<BlockStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: BlockStatus.BLOCK_STATUS_UNSPECIFIED, valueOf: BlockStatus.valueOf, enumValues: BlockStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  BlockStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status(BlockStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
