...
const BlockWrapper$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.massa.model.v1.BlockStatus', '10': 'status'},
  ],
};

/// Descriptor for `BlockWrapper`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List blockWrapperDescriptor = $convert.base64Decode('CgxCbG9ja1dyYXBwZXISGQoIYmxvY2tfaWQYASABKAlSB2Jsb2NrSWQSKwoFYmxvY2sYAiABKAsyFS5tYXNzYS5tb2RlbC52MS5CbG9ja1IFYmxvY2sSMwoGc3RhdHVzGAMgASgOMhsubWFzc2EubW9kZWwudjEuQmxvY2tTdGF0dXNSBnN0YXR1cw==');
