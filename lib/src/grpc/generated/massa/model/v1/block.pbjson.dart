...
final $typed_data.Uint8List blockStatusDescriptor = $convert.base64Decode(
    'CgtCbG9ja1N0YXR1cxIcChhCTE9DS19TVEFUVVNfVU5TUEVDSUZJRUQQABIfChtCTE9DS19TVEFUVVNfSU5fQkxPQ0tDTElRVUUQARIWChJCTE9DS19TVEFUVVNfRklOQUwQAhIaChZCTE9DS19TVEFUVVNfQ0FORElEQVRFEAMSGgoWQkxPQ0tfU1RBVFVTX0RJU0NBUkRFRBAE');
...
const FilledBlock$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.massa.model.v1.FilledOperationTuple',
      '10': 'operations'
    },
  ],
};
...
final $typed_data.Uint8List filledBlockDescriptor = $convert.base64Decode(
    'CgtGaWxsZWRCbG9jaxI5CgZoZWFkZXIYASABKAsyIS5tYXNzYS5tb2RlbC52MS5TaWduZWRCbG9ja0hlYWRlclIGaGVhZGVyEkQKCm9wZXJhdGlvbnMYAiADKAsyJC5tYXNzYS5tb2RlbC52MS5GaWxsZWRPcGVyYXRpb25UdXBsZVIKb3BlcmF0aW9ucw==');
...
const BlockHeader$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'operation_merkle_root',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'operationMerkleRoot'
    },
    const {
      '1': 'endorsements',
      '3': 4,
...
final $typed_data.Uint8List blockHeaderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List filledOperationTupleDescriptor = $convert.base64Decode(
    'ChRGaWxsZWRPcGVyYXRpb25UdXBsZRIhCgxvcGVyYXRpb25faWQYASABKAlSC29wZXJhdGlvbklkEj0KCW9wZXJhdGlvbhgCIAEoCzIfLm1hc3NhLm1vZGVsLnYxLlNpZ25lZE9wZXJhdGlvblIJb3BlcmF0aW9u');
...
final $typed_data.Uint8List signedBlockDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signedBlockHeaderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List blockWrapperDescriptor = $convert.base64Decode(
    'CgxCbG9ja1dyYXBwZXISDgoCaWQYASABKAlSAmlkEisKBWJsb2NrGAIgASgLMhUubWFzc2EubW9kZWwudjEuQmxvY2tSBWJsb2NrEjMKBnN0YXR1cxgDIAMoDjIbLm1hc3NhLm1vZGVsLnYxLkJsb2NrU3RhdHVzUgZzdGF0dXM=');
