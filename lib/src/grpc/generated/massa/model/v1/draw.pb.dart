...
class SelectorDraws extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SelectorDraws', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address')
    ..pc<$3.Slot>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextBlockDraws', $pb.PbFieldType.PM, subBuilder: $3.Slot.create)
    ..pc<$3.IndexedSlot>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextEndorsementDraws', $pb.PbFieldType.PM, subBuilder: $3.IndexedSlot.create)
