...
class SlotDraw extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SlotDraw', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
    ..aOM<$5.Slot>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slot', subBuilder: $5.Slot.create)
    ..aOM<$3.StringValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blockProducer', subBuilder: $3.StringValue.create)
    ..pc<EndorsementDraw>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endorsementDraws', $pb.PbFieldType.PM, subBuilder: EndorsementDraw.create)
  ...
  'Will be removed in next major version')
  SlotDraw copyWith(void Function(SlotDraw) updates) => super.copyWith((message) => updates(message as SlotDraw)) as SlotDraw; // ignore: deprecated_member_use
...
class EndorsementDraw extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndorsementDraw', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'massa.model.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndorsementDraw copyWith(void Function(EndorsementDraw) updates) => super.copyWith((message) => updates(message as EndorsementDraw)) as EndorsementDraw; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
