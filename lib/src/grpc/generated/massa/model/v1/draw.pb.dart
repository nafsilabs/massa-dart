...
class SlotDraw extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.StringValue>(2, _omitFieldNames ? '' : 'blockProducer',
        subBuilder: $3.StringValue.create)
    ..pc<EndorsementDraw>(
        3, _omitFieldNames ? '' : 'endorsementDraws', $pb.PbFieldType.PM,
  ...
  SlotDraw copyWith(void Function(SlotDraw) updates) =>
      super.copyWith((message) => updates(message as SlotDraw)) as SlotDraw;
...
class EndorsementDraw extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EndorsementDraw',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'massa.model.v1'),
      createEmptyInstance: create)
