...
const NodeStatus$json = {
  ...
  '2': [
    ...
    {'1': 'chain_id', '3': 17, '4': 1, '5': 4, '10': 'chainId'},
  ],
};
...
final $typed_data.Uint8List nodeStatusDescriptor = $convert.base64Decode(
    ...
    'ZpZ1IGY29uZmlnEhkKCGNoYWluX2lkGBEgASgEUgdjaGFpbklk');
...
const PublicStatus$json = {
  ...
  '2': [
    ...
    {'1': 'chain_id', '3': 12, '4': 1, '5': 4, '10': 'chainId'},
    {'1': 'minimal_fees', '3': 13, '4': 1, '5': 11, '6': '.massa.model.v1.NativeAmount', '10': 'minimalFees'},
  ],
};
...
final $typed_data.Uint8List publicStatusDescriptor = $convert.base64Decode(
    ...
    'c2EubW9kZWwudjEuQ29tcGFjdENvbmZpZ1IGY29uZmlnEhkKCGNoYWluX2lkGAwgASgEUgdjaG'
    'FpbklkEj8KDG1pbmltYWxfZmVlcxgNIAEoCzIcLm1hc3NhLm1vZGVsLnYxLk5hdGl2ZUFtb3Vu'
    'dFILbWluaW1hbEZlZXM=');
