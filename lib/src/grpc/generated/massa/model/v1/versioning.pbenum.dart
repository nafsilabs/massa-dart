...
class ComponentStateId extends $pb.ProtobufEnum {
  ...
  static const ComponentStateId COMPONENT_STATE_ID_ERROR = ComponentStateId._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPONENT_STATE_ID_ERROR');
  static const ComponentStateId COMPONENT_STATE_ID_DEFINED = ComponentStateId._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPONENT_STATE_ID_DEFINED');
  static const ComponentStateId COMPONENT_STATE_ID_STARTED = ComponentStateId._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
  ...
  static const ComponentStateId COMPONENT_STATE_ID_ACTIVE = ComponentStateId._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPONENT_STATE_ID_ACTIVE');
  static const ComponentStateId COMPONENT_STATE_ID_FAILED = ComponentStateId._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
...
class MipComponent extends $pb.ProtobufEnum {
  static const MipComponent MIP_COMPONENT_UNSPECIFIED = MipComponent._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MIP_COMPONENT_UNSPECIFIED');
  static const MipComponent MIP_COMPONENT_ADDRESS = MipComponent._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MIP_COMPONENT_ADDRESS');
  static const MipComponent MIP_COMPONENT_KEYPAIR = MipComponent._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
