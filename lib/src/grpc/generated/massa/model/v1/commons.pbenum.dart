...
class ComparisonResult extends $pb.ProtobufEnum {
  ...
  static const ComparisonResult COMPARISON_RESULT_LOWER = ComparisonResult._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPARISON_RESULT_LOWER');
  static const ComparisonResult COMPARISON_RESULT_EQUAL = ComparisonResult._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPARISON_RESULT_EQUAL');
  static const ComparisonResult COMPARISON_RESULT_GREATER = ComparisonResult._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
