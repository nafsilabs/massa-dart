...
final $typed_data.Uint8List endorsementIdsDescriptor = $convert.base64Decode('Cg5FbmRvcnNlbWVudElkcxIpChBlbmRvcnNlbWVudHNfaWRzGAEgAygJUg9lbmRvcnNlbWVudHNJZHM=');
...
const EndorsementWrapper$json = const {
  ...
  '2': const [
    ...
    const {'1': 'endorsement', '3': 5, '4': 1, '5': 11, '6': '.massa.model.v1.SignedEndorsement', '10': 'endorsement'},
  ],
};

/// Descriptor for `EndorsementWrapper`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List endorsementWrapperDescriptor = $convert.base64Decode('ChJFbmRvcnNlbWVudFdyYXBwZXISDgoCaWQYASABKAlSAmlkEhcKB2luX3Bvb2wYAiABKAhSBmluUG9vbBIbCglpbl9ibG9ja3MYAyADKAlSCGluQmxvY2tzEhkKCGlzX2ZpbmFsGAQgASgIUgdpc0ZpbmFsEkMKC2VuZG9yc2VtZW50GAUgASgLMiEubWFzc2EubW9kZWwudjEuU2lnbmVkRW5kb3JzZW1lbnRSC2VuZG9yc2VtZW50');
...
const EndorsementInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'in_blocks', '3': 3, '4': 3, '5': 9, '10': 'inBlocks'},
    const {'1': 'is_final', '3': 4, '4': 1, '5': 8, '10': 'isFinal'},
    const {'1': 'endorsement_id', '3': 5, '4': 1, '5': 9, '10': 'endorsementId'},
  ],
};

/// Descriptor for `EndorsementInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List endorsementInfoDescriptor = $convert.base64Decode('Cg9FbmRvcnNlbWVudEluZm8SDgoCaWQYASABKAlSAmlkEhcKB2luX3Bvb2wYAiABKAhSBmluUG9vbBIbCglpbl9ibG9ja3MYAyADKAlSCGluQmxvY2tzEhkKCGlzX2ZpbmFsGAQgASgIUgdpc0ZpbmFsEiUKDmVuZG9yc2VtZW50X2lkGAUgASgJUg1lbmRvcnNlbWVudElk');
