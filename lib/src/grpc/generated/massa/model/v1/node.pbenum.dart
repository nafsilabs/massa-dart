...
class ConnectionType extends $pb.ProtobufEnum {
  ...
  static const ConnectionType CONNECTION_TYPE_INCOMING =
      ConnectionType._(1, _omitEnumNames ? '' : 'CONNECTION_TYPE_INCOMING');
  static const ConnectionType CONNECTION_TYPE_OUTGOING =
      ConnectionType._(2, _omitEnumNames ? '' : 'CONNECTION_TYPE_OUTGOING');
