...
class FinalityLevel extends $pb.ProtobufEnum {
  static const FinalityLevel FINALITY_LEVEL_UNSPECIFIED = FinalityLevel._(0, _omitEnumNames ? '' : 'FINALITY_LEVEL_UNSPECIFIED');
  static const FinalityLevel FINALITY_LEVEL_CANDIDATE = FinalityLevel._(1, _omitEnumNames ? '' : 'FINALITY_LEVEL_CANDIDATE');
  static const FinalityLevel FINALITY_LEVEL_FINAL = FinalityLevel._(2, _omitEnumNames ? '' : 'FINALITY_LEVEL_FINAL');

  static const $core.List<FinalityLevel> values = <FinalityLevel> [
    FINALITY_LEVEL_UNSPECIFIED,
    FINALITY_LEVEL_CANDIDATE,
    FINALITY_LEVEL_FINAL,
  ];

  static final $core.Map<$core.int, FinalityLevel> _byValue = $pb.ProtobufEnum.initByValue(values);
  static FinalityLevel? valueOf($core.int value) => _byValue[value];

  const FinalityLevel._($core.int v, $core.String n) : super(v, n);
}
