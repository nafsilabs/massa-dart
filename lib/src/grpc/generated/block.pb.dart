...
class BlockHeader extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set operationMerkleRoot($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class FilledOperationTuple extends $pb.GeneratedMessage {
  ...
  factory FilledOperationTuple.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FilledOperationTuple.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FilledOperationTuple clone() => FilledOperationTuple()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FilledOperationTuple copyWith(void Function(FilledOperationTuple) updates) => super.copyWith((message) => updates(message as FilledOperationTuple)) as FilledOperationTuple; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FilledOperationTuple create() => FilledOperationTuple._();
  FilledOperationTuple createEmptyInstance() => create();
  static $pb.PbList<FilledOperationTuple> createRepeated() => $pb.PbList<FilledOperationTuple>();
  @$core.pragma('dart2js:noInline')
  static FilledOperationTuple getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FilledOperationTuple>(create);
