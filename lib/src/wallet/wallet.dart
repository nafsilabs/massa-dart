...
class Wallet {
  ...
  Future<Account> addAccountFromSecretKey(
      String secret, AddressType addressType, NetworkType networkType) async {
...
// Creates a new account and add it into the wallet
  Future<Account> newAccount(
      AddressType addressType, NetworkType networkType) async {
